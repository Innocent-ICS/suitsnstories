            ...
            <div className="container px-4 mx-auto">
                <div className="max-w-4xl mx-auto text-center">
                    <div className="mb-24 space-y-8">
                        <span className="text-xs md:text-sm font-bold tracking-[0.2em] text-primary/80 uppercase block mb-4">
                            The Broken Status Quo
                        </span>
                        <h2 className="text-4xl md:text-6xl font-serif text-foreground font-medium tracking-tight mb-8">
